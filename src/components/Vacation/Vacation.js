...
const Vacation = ({ title, formValues, vacationLeft, employeeIds, selectedEmployee, handleSubmit, onSubmit }) => (
    <section>
        <h1>Urlaubsantrag</h1>
        <form onSubmit={handleSubmit(onSubmit)}>
            <div><Field name="fromId" label="Mitarbeiter" options={employeeIds} component={Select}/></div>
            ...
            <div><TextField label="Resturlaubstage" value={vacationLeft} /></div>
            <br />
            <div className={'right'}>
